...
class PDFGenerator:
    def __init__(self, filename):
        ...
        self.title_style = ParagraphStyle(
            name="TitleStyle", fontName="pingbold", fontSize=48, alignment=TA_LEFT
        )
    ...
    def genTaskPDF(
        ...
        story.append(
            Paragraph(" 负责人：" + home_data["report_creator"], self.content_style)
        )
        ...
        basic_table = Table(
            basic_data,
            colWidths=[25 * mm, 61 * mm, 25 * mm, 55 * mm],
            rowHeights=12 * mm,
        ...
        story.append(Spacer(1, 3 * mm))
        para_fail_case_data = [
            [Paragraph(cell, body_style) for cell in row] for row in fail_case_data
        ]
        fail_case_table = Table(
            para_fail_case_data, colWidths=[20 * mm, 35 * mm, 91 * mm, 20 * mm]
        )
        ...
        story.append(Spacer(1, 3 * mm))
        para_p0_case_data = [
            [Paragraph(cell, body_style) for cell in row] for row in p0_case_data
        ]
        p0_case_table = Table(
            para_p0_case_data, colWidths=[20 * mm, 35 * mm, 91 * mm, 20 * mm]
        )
